...
def process_file(args):
    """
    read the contents of the compressed.xz file
    write them to the output file
    return the unique characters in the content
    """
...
def xz_files_in_dir(directory):
    """
    return a list containing the name of regular files and that end with .xz
    """
...
# Process the training/validation files
...
# Combine voc(if needed) and write to vocab.txt:
vocab = vocab_train.union(vocab_val) # 取两个集合的并集
